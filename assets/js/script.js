            ...
            success: function(json) {
				...
				if(json.nameMessage == '' && json.emailMessage == '' && json.fonoMessage == '' && json.messageMessage == '') {
                	form.fadeOut('fast', function() {
                		form.parent('.contact-form').append('<p class="bgmsn"><span class="green">Gracias, tu mensaje ha sido enviado!</span> Nos pondremos en contacto contigo a la brevedad posible. <a href="http://www.kitoperu.com/">Actualizar</a></p>');
                    });
                }
            }
        });
